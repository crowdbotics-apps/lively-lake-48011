"""
Django settings for lively_lake_48011 project.
...
ROOT_URLCONF = 'lively_lake_48011.urls'
...
WSGI_APPLICATION = 'lively_lake_48011.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "lively_lake_48011 API",
    "DESCRIPTION": "API documentation for lively_lake_48011 App",
    "VERSION": "v1",
}
